...
/*
	...
	Function Description : Bring up every peripheral the application needs (global interrupts, servo/appliance PWM timers, UART, ADC, DIO/LCD/keypad) and set pin directions from the PinCFG table. Call once at the top of main().
*/
void BSP_Init(void);
